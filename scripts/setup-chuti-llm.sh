...
echo "Checking for base model llama3.2:3b..."
if ! ollama list | grep -q "llama3.2:3b"; then
    echo "📥 Base model not found. Pulling llama3.2:3b..."
    echo "This may take a few minutes depending on your connection..."
    ollama pull llama3.2:3b
    echo "✅ Base model pulled successfully"
else
    echo "✅ Base model llama3.2:3b already exists"
fi
echo ""
...
echo "📦 Building custom model chuti-llama3.2:3b with game rules..."
echo "This will create a model with Chuti game rules embedded in the system prompt."
echo ""

# Build custom model
ollama create chuti-llama3.2:3b -f ai/Modelfile.chuti
