curl 'http://localhost:8079/unauth/chat/schema' \
...
curl 'http://localhost:8079/unauth/chuti/schema' \
  ...
  -H 'sec-fetch-user: ?1' \
  -H 'upgrade-insecure-requests: 1' \
  -H 'user-agent: Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36' > /home/rleibman/projects/chuti/server/src/main/graphql/game.gql
