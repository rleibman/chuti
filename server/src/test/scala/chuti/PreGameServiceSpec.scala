...
object PreGameServiceSpec extends ZIOSpecDefault {
  ...
  //            operation <-
  //              gameService
  //                .newGame(satoshiPerPoint = 100).provideLayer(
  //                  layer,
  ...
  //              abandonedGame <-
  //                gameService
  //                  .abandonGame(GameId(1)).provideLayer(
  //                    layer,
  //                    SessionContext.live(ChutiSession(user2))
  //                  )
  //              gameEvents <- gameEventsFiber.join
  ...
  //              invited <-
  //                gameService
  //                  .inviteToGame(user2.id.get, game.id.get).provideLayer(
  //                    layer,
  //                    SessionContext.live(ChutiSession(user1))
  //                  )
  //              gameEvents <- gameEventsFiber.join
  ...
  //              _ <-
  //                gameService
  //                  .inviteToGame(user3.id.get, game.id.get).provideLayer(
  //                    layer,
  //                    SessionContext.live(ChutiSession(user1))
  //                  )
  //              _ <-
  //                gameService
  //                  .inviteToGame(user4.id.get, game.id.get).provideLayer(
  //                    layer,
  //                    SessionContext.live(ChutiSession(user1))
  //                  )
  //              accepted2 <-
  //                gameService
  //                  .acceptGameInvitation(game.id.get).provideLayer(
  //                    layer,
  //                    SessionContext.live(ChutiSession(user2))
  //                  )
  //              accepted3 <-
  ...
  //              _ <-
  //                gameService
  //                  .declineGameInvitation(game.id.get).provideLayer(
  //                    layer,
  //                    SessionContext.live(ChutiSession(user3))
  //                  )
  //              accepted4 <-
