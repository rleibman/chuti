...
import chuti.{GameEvent, GameState, Jugador, User, UserId}
...
//
//trait GameServer extends Repository.Service {
//  //Game running stuff
...
//  }
//  def gameEventStream(gameId: Int): ZStream[SessionProvider, Nothing, GameEvent] = ???
//}
