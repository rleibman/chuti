...
case class OllamaConfig(
  ...
  maxTokens:        Int = 500,
  timeout:          Duration = Duration(2, java.util.concurrent.TimeUnit.MINUTES),     // Outer (ZIO) timeout
  httpTimeout:      Duration = Duration(110, java.util.concurrent.TimeUnit.SECONDS),   // Inner (HTTP) timeout
